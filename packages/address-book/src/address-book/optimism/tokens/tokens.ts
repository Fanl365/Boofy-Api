...
export const tokens = {
  ...
  beOPX: {
    ...
    description:
      'Boofy Escrowed OPX is a liquid staking solution to earn maximum governance rewards from the OPX platform using the highest tier NFT and maximum lock.',
  },
  OPX: {
    name: 'OPX',
    symbol: 'OPX',
  ...
  beVELO: {
    ...
    website: 'https://boofy.com',
    description:
      'beVELO is Boofy-wrapped VELO that earns more VELO over time. Boofy distributes trading fees and bribe rewards weekly to beVELO holders, swapping VELO to beVELO. beVELO holders receive the same rewards as max-locked veNFT VELO holders.',
    documentation: 'https://docs.boofy.finance/boofy-products/boofy-escrowed-tokens/bevelo',
    bridge: 'native',
  },
  EURA: {
  ...
  MLP: {
    ...
    chainId: 10,
    decimals: 18,
    website: 'https://app.mummy.finance/#/trade?ref=boofy',
    description:
