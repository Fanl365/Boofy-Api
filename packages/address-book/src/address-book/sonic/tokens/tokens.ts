...
export const tokens = {
  ...
  beS: {
    ...
    chainId: 146,
    decimals: 18,
    website: 'https://www.boofy.com/',
    description:
      'Boofy-escrowed Sonic (beS) is a liquid staking derivative of Sonic (S). It automatically stakes a user’s wS tokens to earn staking rewards. Each beS token represents a proportional share of the staked wS, including any rewards accrued over time. Users can convert beS back to wS with a 14-day unbonding period, or freely trade beS on the open market.',
    documentation: 'https://docs.boofy.finance/boofy-products/boofy-escrowed-tokens/bes',
    bridge: 'native',
  },
  FIVE: {
    name: 'FIVE',
  ...
  beGEMS1: {
    name: 'Boofy Gems Season 1',
    symbol: 'beGEMS1',
    oracleId: 'beGEMS1',
    address: '0xd70c020c48403295100884ee47db80d51BAA9d87',
    chainId: 146,
    decimals: 18,
    website: 'https://app.boofy.com/campaigns/begems',
    description:
      'beGEMS are a liquid ERC-20 token issued by Boofy that represent its share of Sonic Gems airdrop rewards, earned by users through boosting vaults, providing liquidity, or voting for beS pairs across Sonic exchanges.',
    documentation: 'https://docs.boofy.com/',
    bridge: 'native',
  },
  STRIKE: {
