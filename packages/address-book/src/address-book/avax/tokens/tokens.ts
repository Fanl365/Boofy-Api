...
export const tokens = {
  ...
  beJOE: {
    ...
    description:
      'beJOE is a Boofy-wrapped version of veJOE. Holding beJOE will be a great way to earn a bunch of JOE. Boofy will max out emissions on boosted farms, 5% of emissions will then be distributed to beJOE stakers on Boofy.',
  },
  YETI: {
    name: 'Yeti YETI',
    symbol: 'YETI',
  ...
  GLP: {
    ...
    chainId: 43114,
    decimals: 18,
    website: 'https://app.gmx.io/#/trade/?ref=boofy',
    description:
