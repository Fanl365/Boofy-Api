...
export const tokens = {
  ...
  binSPIRIT: {
    ...
    bridge: 'native',
    description:
      'binSPIRIT is the Boofy wrapped version of inSPIRIT which boosts Spirit vaults on Boofy. binSPIRIT can be traded or minted 1:1 with SPIRIT.',
    documentation:
      'https://docs.boofy.finance/boofy-products/boofy-escrowed-tokens/binspirit#what-is-binspirit',
  },
  CREDIT: {
    name: 'Creditum',
    symbol: 'CREDIT',
  ...
  beFTM: {
    name: 'Boofy Escrowed Fantom',
    symbol: 'beFTM',
    oracleId: 'beFTM',
    address: '0x7381eD41F6dE418DdE5e84B55590422a57917886',
    chainId: 250,
    decimals: 18,
    website: 'https://blog.boofy.finance/articles/introducing-beftm/',
    bridge: 'native',
    description:
      'Boofy Escrowed Fantom is 1 year perpetually lock FTM that is delegated and locked to earn the maximum validator reward',
    documentation: 'https://docs.boofy.finance/boofy-products/boofy-escrowed-tokens/beftm',
  },
  sfUSDC: {
