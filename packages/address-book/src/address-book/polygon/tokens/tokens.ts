...
export const tokens = {
  ...
  beQI: {
    ...
    description:
      'beQI is a Boofy-wrapped version of eQI. Holding beQI will be a great way to earn a bunch of QI. Boofy will distribute weekly QI rewards to beQI stakers. beQI holders will recieve the same rewards as max lock eQI holders',
    documentation: 'https://docs.boofy.finance/boofy-products/boofy-escrowed-tokens/beqi',
    bridge: 'native',
  },
  stMATIC: {
