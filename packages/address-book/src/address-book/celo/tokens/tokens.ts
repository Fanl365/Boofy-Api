...
export const tokens = {
  ...
  oldBIFI: {
    ...
    symbol: 'oldBIFI',
    oracleId: 'oldBIFI',
    website: 'https://www.boofy.finance/',
    description:
      'Boofy Finance is a Decentralized, Multi-Chain Yield Optimizer platform that allows its users to earn compound interest on their crypto holdings.',
  },
  cUSD: {
    name: 'Celo Dollar',
    symbol: 'cUSD',
