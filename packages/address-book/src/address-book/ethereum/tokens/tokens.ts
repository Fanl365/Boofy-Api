...
export const tokens = {
  ...
  BIFI: {
    ...
    documentation: 'https://docs.boofy.finance/',
    description:
      "The Boofy Token (BIFI) is the governance token of the Boofy DAO. Holders of the token are entitled to submit and vote on proposals on all areas affecting the DAO through the Boofy Snapshot Space, as well as to participate in Boofy's governance incentives programme through the BIFI Pool or BIFI Vault.",
    bridge: 'native',
    tags: ['BLUECHIP'],
  },
  rBIFI: {
  ...
  mooBIFI: {
    ...
    documentation: 'https://docs.boofy.finance/',
    description:
      "The incentive-bearing Boofy Token (mooBIFI) applies the magic of Boofy's autocompounding technology to the BIFI token. It is the vault token for the BIFI Vault, which automatically claims and swaps governance incentives into more BIFI, and redeposits to unlock exponential growth. On chains other than Ethereum, mooBIFI is a bridged copy of the native Ethereum token, and cannot be returned to BIFI without first bridging back to Ethereum. mooBIFI holders on all chains retain their full voting power corresponding to the underlying amount of BIFI deposited and compounding on Ethereum.",
    bridge: 'native',
    tags: ['BLUECHIP'],
  },
  xmooBIFI: {
  ...
  beQI: {
    ...
    website: 'https://app.mai.finance/',
    description:
      'Boofy QI is perpetually lock QI/ETH Balancer Pool Token. QiDao is an overcollateralized stablecoin protocol that allows users to mint stablecoins (MAI) against the value of their decentralized token collaterals. Minting occurs through loans, denomimated in MAI stablecoins. Most loans have 0% interest, meaning the value of the related debt does not change over time.',
    documentation: 'https://docs.mai.finance/introduction-1',
    bridge: 'native',
  },
  USDe: {
