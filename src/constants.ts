...
/// Boofy Vaults Endpoints
const BSC_VAULTS_ENDPOINT = 'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/bsc.json';
const HECO_VAULTS_ENDPOINT = 'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/heco.json';
const AVAX_VAULTS_ENDPOINT = 'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/avax.json';
const POLYGON_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/polygon.json';
const FANTOM_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/fantom.json';
const ONE_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/harmony.json';
const ARBITRUM_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/arbitrum.json';
const CELO_VAULTS_ENDPOINT = 'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/celo.json';
const MOONRIVER_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/moonriver.json';
const CRONOS_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/cronos.json';
const AURORA_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/aurora.json';
const FUSE_VAULTS_ENDPOINT = 'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/fuse.json';
const METIS_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/metis.json';
const MOONBEAM_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/moonbeam.json';
const EMERALD_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/emerald.json';
const OPTIMISM_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/optimism.json';
const KAVA_VAULTS_ENDPOINT = 'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/kava.json';
const ETHEREUM_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/ethereum.json';
const CANTO_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/canto.json';
const ZKSYNC_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/zksync.json';
const ZKEVM_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/zkevm.json';
const BASE_VAULTS_ENDPOINT = 'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/base.json';
const GNOSIS_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/gnosis.json';
const LINEA_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/linea.json';
const MANTLE_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/mantle.json';
const FRAXTAL_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/fraxtal.json';
const MODE_VAULTS_ENDPOINT = 'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/mode.json';
const MANTA_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/manta.json';
const REAL_VAULTS_ENDPOINT = 'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/real.json';
const SEI_VAULTS_ENDPOINT = 'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/sei.json';
const ROOTSTOCK_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/rootstock.json';
const SCROLL_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/scroll.json';
const LISK_VAULTS_ENDPOINT = 'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/lisk.json';
const SONIC_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/sonic.json';
const BERACHAIN_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/berachain.json';
const UNICHAIN_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/unichain.json';
const SAGA_VAULTS_ENDPOINT = 'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/saga.json';
const HYPEREVM_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/hyperevm.json';
const PLASMA_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/plasma.json';
const MONAD_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/monad.json';
const MEGAETH_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/megaeth.json';
const ROBINHOOD_VAULTS_ENDPOINT =
  'https://raw.githubusercontent.com/boofyfinance/boofy-v2/prod/src/config/vault/robinhood.json';
