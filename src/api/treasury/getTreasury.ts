...
function updateTreasuryAddressesByChain() {
  treasuryAddressesByChain = keysToObject(SupportedChains, chain => {
    ...
    const treasuryMultisig = chainAddressbook.platforms.boofyfinance.treasuryMultisig;
    const treasury = chainAddressbook.platforms.boofyfinance.treasury;
...
export function getBoofyTreasury(): TreasuryReport {
