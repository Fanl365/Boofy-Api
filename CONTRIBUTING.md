...
```sh
git clone https://github.com/<you>/boofy-api.git
cd boofy-api
pnpm install
```
...
Open an issue at
[github.com/boofyfinance/boofy-api/issues](https://github.com/boofyfinance/boofy-api/issues).
