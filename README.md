...
The backend that powers [Boofy](https://app.boofy.com). It reads prices, APYs, TVL and vault
metadata from the chains Boofy is deployed on, caches them in memory, and serves them as JSON.

The frontend lives in [boofy-v2](https://github.com/boofyfinance/boofy-v2). The endpoint reference
is published at [docs.boofy.finance](https://docs.boofy.finance/developer-documentation/boofy-api).
